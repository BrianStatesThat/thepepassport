      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex justify-between items-center h-16 gap-4">
          ...
          <div className="flex md:hidden items-center gap-2 relative overflow-visible">
            ...
            {/* Mobile Menu Drawer */}
            {menuActive && (
              <div className="absolute right-0 top-full mt-2 z-40 w-[90vw] max-w-105 overflow-hidden rounded-2xl border border-gray-200 dark:border-slate-700 bg-white/95 dark:bg-slate-900/95 shadow-xl backdrop-blur-sm">
