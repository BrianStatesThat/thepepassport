...
export default function SearchPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      {/* Search Bar Section */}
      <section className="bg-linear-to-r from-blue-500 to-blue-600 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <input
              ...
              className="flex-1 px-6 py-3 rounded-lg bg-white text-dark-gray placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-300"
            />
            <button
              type="submit"
